...
.factory('rosterAPIService', function ($http) {
    ...
    rosterAPI.getRosterStatus = function () {
        ...
        console.debug("Fetching roster status ")
...
.factory('instancesAPIService', function ($http) {
    ...
    instancesAPI.getProfileList = function () {
        ...
        console.debug("Fetching Profile List ")
    ...
    instancesAPI.getProfile = function (profileID) {
        ...
        if (profileID) {
            ...
            console.debug("Fetching Profile: " + profileID)
    ...
    instancesAPI.getInstanceList = function () {
        ...
        console.debug("Fetching Instance List ")
    ...
    instancesAPI.getInstance = function (instanceID) {
        ...
        if (instanceID) {
            ...
            console.debug("Fetching Instance: " + instanceID)
    ...
    instancesAPI.createProfile = function (profile) {
        ...
        if (profile) {
            ...
            console.debug("Creating Profile: " + profile.ID[0].text)
    ...
    instancesAPI.deleteProfile = function (profileID) {
        ...
        if (profileID) {
            ...
            console.debug("Deleting Profile: " + profileID)
    ...
    instancesAPI.deleteInterest = function (profileID, interest) {
        ...
        if (profileID && interest) {
            ...
            console.debug("Removing Interest: " + interest)
    ...
    instancesAPI.addInterest = function (profileID, interest) {
        ...
        if (profileID && interest) {
            ...
            console.debug("Adding Interest: " + interest)
    ...
    instancesAPI.createInstance = function (instance) {
        ...
        if (instance) {
            ...
            console.debug("Creating Instance: " + instance.ID[0].text)
    ...
    instancesAPI.deleteInstance = function (instanceID) {
        ...
        if (instanceID) {
            ...
            console.debug("Deleting Instance: " + instanceID)
...
.factory('usersAPIService', function ($http) {
    ...
    usersAPI.createUser = function (user) {
        ...
        if (user) {
            ...
            if (user.latitude != '' && user.longitude != '') {
                ...
                console.debug("Creating User " + user.displayName)
    ...
    usersAPI.createGroup = function (group) {
        ...
        if (group) {
            ...
            console.debug("Creating group " + group.displayName)
    ...
    usersAPI.updateUser = function (user, updates) {
        ...
        if (updates.length > 0) {
            ...
            var jsonRequest = updates;
                   ...
                   console.debug("Updating user " + user.displayName)
    ...
    usersAPI.updateGroup = function (group, updates) {
        ...
        if (updates.length > 0) {
            ...
            var jsonRequest = updates;
                    ...
                    console.debug("Updating group " + group.displayName)
    ...
    usersAPI.deleteUser = function (user) {
        ...
        console.debug("Deleting user " + user.displayName)
    ...
    usersAPI.deleteGroup = function (group) {
        ...
        console.debug("Deleting group " + group.displayName)
...
.factory('workProductAPIService', function ($http, $q) {
    ...
    workProductAPI.closeWorkProduct = function (workproduct) {
        ...
        console.debug("Closing product: " + id)
    ...
    workProductAPI.archiveWorkProduct = function (workproduct) {
        ...
        console.debug("Archiving product: " + id)
    ...
    // for this to work, we must get the closed WP from the results
    // workProductAPI.closeAndArchiveWorkProduct = function(workproduct) {
    // 	return $q.all([
    //             workProductAPI.closeWorkProduct(workproduct)
    //         ]).then(function (results) {
    //         	var closedWP = ///?
    // workProductAPI.archiveWorkProduct(closedWP)
    //         })
    // }    
...
.factory('incidentAPIService', function ($http, $q) {
    ...
    incidentAPI.closeIncident = function (igID) {
        ...
        console.debug("Closing incident: " + igID)
    ...
    incidentAPI.archiveIncident = function (igID) {
        ...
        console.debug("Archiving incident: " + igID)
