...
let $incidentIcon := props:get-property($parameters, "incidentIcon", "http://maps.google.com/mapfiles/kml/shapes/open-diamond.png")
...
<kml xmlns="http://www.opengis.net/kml/2.2">
    <Folder>
        ...
        {
           let $incidents := $workproducts//NS_PRECIS_STRUCTURES:WorkProduct[NS_ULEX_STRUCTURE:PackageMetadata[1]/NS_PRECIS_STRUCTURES:WorkProductIdentification/NS_PRECIS_BASE:Type="Incident"]
           return
           if ($incidents) then
               ...
               return
    				...
    				for $subType in fn:distinct-values($workproducts//NS_PRECIS_STRUCTURES:WorkProduct/NS_ULEX_STRUCTURE:PackageMetadata/NS_PRECIS_STRUCTURES:WorkProductIdentification/NS_PRECIS_BASE:Type)
                    return  
                        <Folder>
                            <name>{$subType}</name>
                            {
                                for $subproduct in $workproducts//NS_PRECIS_STRUCTURES:WorkProduct[fn:data(NS_ULEX_STRUCTURE:PackageMetadata[1]/NS_PRECIS_STRUCTURES:WorkProductIdentification[1]/NS_PRECIS_BASE:Type)=$subType]
